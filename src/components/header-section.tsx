...
export const HeaderSection = () => {
	...
	useEffect(() => {
		if (firstImageRef.current?.complete) setIsCarouselReady(true)
	}, [])
	...
	return (
		<section
			...
			className="relative grid h-[calc(100svh-4rem)] min-h-0 w-full grid-rows-[minmax(6rem,27fr)_73fr] overflow-clip bg-primary lg:h-[min(900px,calc(100svh-4.5rem))] lg:min-h-175 lg:grid-cols-2 lg:grid-rows-1"
		>
			<div className="px-5 py-4 lg:px-16">
				<h1
					id="hero-heading"
					className="font-sans text-[1.25rem] font-medium leading-6 tracking-normal text-primary-foreground lg:font-display lg:text-2xl lg:leading-[1.4] lg:tracking-[-0.03em] text-pretty"
				>
			...
			<div
				...
				className="relative min-h-0 overflow-hidden bg-primary"
				role="img"
			>
				<div
					className={`absolute inset-0 transition-opacity duration-500 ease-out-quad motion-reduce:transition-none ${
